...
struct VAO *create3DObject(GLenum primitive_mode, int numVertices, const GLfloat *vertex_buffer_data, const GLfloat red, const GLfloat green, const GLfloat blue,const GLfloat *normal_buffer_data , GLenum fill_mode) {
...
struct VAO *create3DObject(GLenum primitive_mode, int numVertices, const GLfloat *vertex_buffer_data, const color_t color,const GLfloat *normal_buffer_data, GLenum fill_mode) {
    return create3DObject(primitive_mode, numVertices, vertex_buffer_data, color.r / 256.0, color.g / 256.0, color.b / 256.0, normal_buffer_data,fill_mode);
}
